...
func (b *Book) Trade() {
	...
	for order := range b.OrdersChan {
		...
		if buyOrders[asset] == nil {
			buyOrders[asset] = initializeOrderQueue(asset)
		}

		if sellOrders[asset] == nil {
			sellOrders[asset] = initializeOrderQueue(asset)
		}
...
func initializeOrderQueue(asset string) *OrderQueue {
...
func (b *Book) AddTransaction(transaction *Transaction, wg *sync.WaitGroup) {
	...
	minShares := min(transaction.SellingOrder.PendingShares, transaction.BuyingOrder.PendingShares)
